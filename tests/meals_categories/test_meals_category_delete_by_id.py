...
def test_delete_meals_category_by_id_empty(client):
    def delete_meals_category_by_id_empty(id, user: User) -> int | None:
        return None
    ...
    with client.session_transaction() as session:
        ...
        assert flash_message == "Не удалось удалить категорию блюда"


def test_delete_meals_category_by_id_empty_unauthorized(client):
    def delete_meals_category_by_id_empty(id, user: User) -> int | None:
        return None
...
def test_delete_meals_category_by_id_empty_unauthorized_no_cookie_header(client):
    def delete_meals_category_by_id_empty(id, user: User) -> int | None:
        return None
...
def test_delete_meals_category_by_id_not_empty(client):
    def delete_meals_category_by_id_not_empty(id, user: User) -> int | None:
        return 1
...
def test_delete_meals_category_by_id_not_empty_unauthorized(client):
    def delete_meals_category_by_id_not_empty(id, user: User) -> int | None:
        return 1
...
def test_delete_meals_category_by_id_not_empty_unauthorized_no_cookie_header(client):
    def delete_meals_category_by_id_not_empty(id, user: User) -> int | None:
        return 1
