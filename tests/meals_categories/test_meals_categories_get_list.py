...
def test_get_meals_categories_empty_unauthorized(client):
    def get_meals_categories_mock_empty(user: User) -> List[MealsCategory]:
        return []
...
def test_get_meals_categories_empty_unauthorized_no_cookie_header(client):
    def get_meals_categories_mock_empty(user: User) -> List[MealsCategory]:
        return []
...
def test_get_meals_categories_not_empty_unauthorized(client):
    def get_meals_categories_mock_not_empty(user: User) -> List[MealsCategory]:
        return [
            MealsCategory(1, "Десерт", user),
            MealsCategory(2, "Ужин", user),
...
def test_get_meals_categories_not_empty_unauthorized_no_cookie_header(client):
    def get_meals_categories_mock_not_empty(user: User) -> List[MealsCategory]:
        return [
            MealsCategory(1, "Десерт", user),
            MealsCategory(2, "Ужин", user),
