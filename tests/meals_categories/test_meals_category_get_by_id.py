...
def test_get_meals_category_by_id_empty(client):
    def get_meals_category_by_id_empty(id: str, user: User) -> MealsCategory | None:
        assert user.id == 1
...
def test_get_meals_category_by_id_empty_unauthorized(client):
    def get_meals_category_by_id_empty(id: str, user: User) -> MealsCategory | None:
        return None
...
def test_get_meals_category_by_id_empty_unauthorized_no_cookie_header(client):
    def get_meals_category_by_id_empty(id: str, user: User) -> MealsCategory | None:
        return None
...
def test_get_meals_category_by_id_not_empty(client):
    def get_meals_category_by_id_not_empty(id: str, user: User) -> MealsCategory | None:
        assert user.id == 1
        assert user.login == "salta"
        return MealsCategory(1, "Десерт", user)
...
def test_get_meals_category_by_id_not_empty_unauthorized(client):
    def get_meals_category_by_id_not_empty(id: str, user: User) -> MealsCategory | None:
        return MealsCategory(1, "Десерт", user)
...
def test_get_meals_category_by_id_not_empty_unauthorized_no_cookie_header(client):
    def get_meals_category_by_id_not_empty(id: str, user: User) -> MealsCategory | None:
        return MealsCategory(1, "Десерт", user)
