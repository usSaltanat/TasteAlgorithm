...
def test_get_unit_by_id_empty(client):
    def get_unit_by_id_empty(id: str, user: User) -> Unit | None:
        assert user.id == 1
...
def test_get_unit_by_id_empty_unauthorized(client):
    def get_unit_by_id_empty(id: str, user: User) -> Unit | None:
        return None
...
def test_get_unit_by_id_empty_unauthorized_no_cookie_header(client):
    def get_unit_by_id_empty(id: str, user: User) -> Unit | None:
        return None
...
def test_get_unit_by_id_not_empty(client):
    def get_unit_by_id_not_empty(id: str, user: User) -> Unit | None:
        assert user.id == 1
        assert user.login == "salta"
        return Unit(1, "шт", user)
...
def test_get_unit_by_id_not_empty_unauthorized(client):
    def get_unit_by_id_not_empty(id: str, user: User) -> Unit | None:
        return Unit(1, "шт", user)
...
def test_get_unit_by_id_not_empty_unauthorized_no_cookie_header(client):
    def get_unit_by_id_not_empty(id: str, user: User) -> Unit | None:
        return Unit(1, "шт", user)
