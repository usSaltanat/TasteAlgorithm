...
def test_get_meal_by_id_empty(client):
    def get_meal_by_id_empty(id: str, user: User) -> Meal | None:
        assert user.id == 1
...
def test_get_meal_by_id_empty_unauthorized(client):
    def get_meal_by_id_empty(id: str, user: User) -> Meal | None:
        return None
...
def test_get_meal_by_id_empty_unauthorized_no_cookie_header(client):
    def get_meal_by_id_empty(id: str, user: User) -> Meal | None:
        return None
...
def test_get_meal_by_id_not_empty(client):
    def get_meal_by_id_not_empty(id: str, user: User) -> Meal | None:
        assert user.id == 1
        assert user.login == "salta"
        return Meal(1, "Сырники", MealsCategory(1, "Десерт", user), user)
...
def test_get_meal_by_id_not_empty_unauthorized(client):
    def get_meal_by_id_not_empty(id: str, user: User) -> Meal | None:
        return Meal(1, "Сырники", MealsCategory(1, "Десерт", user), user)
...
def test_get_meal_by_id_not_empty_unauthorized_no_cookie_header(client):
    def get_meal_by_id_not_empty(id: str, user: User) -> Meal | None:
        return Meal(1, "Сырники", MealsCategory(1, "Десерт", user), user)
